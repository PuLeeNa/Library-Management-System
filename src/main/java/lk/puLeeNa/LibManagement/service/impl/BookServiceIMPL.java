...
//        BookDTO selectedBookDTO = entityDTOConvert.convertBookEntityToDTO(selectedBookEntity);
//        return selectedBookDTO;

        return entityDTOConvert.convertBookEntityToDTO(bookDao.getReferenceById(bookId));
    }
